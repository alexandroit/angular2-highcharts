...
const HighchartsAnnotations: any = require('highcharts/modules/annotations');
// Highcharts 10 and 11 modules
const HighchartsDrilldown: any = require('highcharts/modules/drilldown');
const HighchartsArcDiagram: any = require('highcharts/modules/arc-diagram');
const HighchartsTreemap: any = require('highcharts/modules/treemap');
const HighchartsTreegraph: any = require('highcharts/modules/treegraph');
// Highcharts 12 modules
const HighchartsPointAndFigure: any = require('highcharts/modules/pointandfigure');
const HighchartsRenko: any = require('highcharts/modules/renko');
...
@NgModule({
  ...
  imports: [
    ...
    ChartModule.forRoot(
      ...
      HighchartsDrilldown,
      HighchartsArcDiagram,
      HighchartsTreemap,
      HighchartsTreegraph,
      HighchartsPointAndFigure,
      HighchartsRenko
    )
  ],
