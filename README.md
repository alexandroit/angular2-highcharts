...
> A maintained **Angular 13 wrapper for Highcharts** with support for standard charts, `StockChart`, `Highmaps`, wrapper event outputs, native chart instance access, and Angular directives for `xAxis`, `yAxis`, `zAxis`, and `colorAxis`.
...
[![Angular 13](https://img.shields.io/badge/Angular-13-red?style=flat-square&logo=angular)](https://angular.dev)
[![TypeScript](https://img.shields.io/badge/TypeScript-4.6-blue?style=flat-square&logo=typescript)](https://www.typescriptlang.org)
...
| Feature | Supported |
| :--- | :---: |
| Angular 13 wrapper release line | ✅ |
| Backward-compatible with Angular 4, 5, 6, 7, 8, 9, 10, 11, and 12 apps | ✅ |
